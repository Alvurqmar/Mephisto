...
export default function Home() {
  return (
    ...
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-uncial-antiqua)] bg-[url('/MephistoBG.jpg')] bg-cover bg-no-repeat bg-center bg-">
              <Image
      ...
      <main className="flex flex-col gap-[128px] row-start-2 items-center sm:items-start">
        ...
        <ul className="list-inside text-sm/6 text-center sm:text-left font-[family-name:var(--font-uncial-antiqua)] text-outline-dark">
        ...
        <div className= "rounded-full border border-solid text-outline-dark text-3xl tracking-wide text-[#d4af37] ">
      ...
      <footer className="row-start-3 flex gap-[24px] flex-wrap items-center justify-start">
        <a
            ...
            href="https://github.com/Alvurqmar/Mephisto_Tabletop.git"
            target="_blank"
